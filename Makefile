...
build/catch_main.o: test/catch/*
	g++ -std=gnu++11 test/catch/catch_main.cpp -c -o build/catch_main.o

build/mock_arduino.o: test/mock/Arduino*
	g++ -std=gnu++11 -I test/mock test/mock/Arduino.cpp -c -o build/mock_arduino.o

build/mock_wire.o: test/mock/Wire*
	g++ -std=gnu++11 -I test/mock test/mock/Wire.cpp -c -o build/mock_wire.o

build/mock_serial.o: test/mock/Serial*
	g++ -std=gnu++11 -I test/mock test/mock/Serial.cpp -c -o build/mock_serial.o

build/mock_string.o: test/mock/String*
	g++ -std=gnu++11 -I test/mock test/mock/String.cpp -c -o build/mock_string.o
